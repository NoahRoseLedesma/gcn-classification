...
class Dataset_Loader():
    ...
    def __init__(self, dataset_name):
        ...
        self.dataset_source_folder_path = "data/" + dataset_name
    ...
    def load(self):
        ...
        data = Data(x=features, y=labels, edge_index=edges, train_mask=idx_train, val_mask=idx_val, test_mask=idx_test)
        # Set the number of classes
        data.num_classes = num_classes

        # Transpose the edge data
        data.edge_index = torch.LongTensor(data.edge_index).t().contiguous()
